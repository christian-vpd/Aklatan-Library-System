            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="row d-flex align-items-center mt-3">
                        <div class="col-6">
                            <label class="form-label required">Last Name</label>
                            <input type="text" class="form-control" name="edit_lastName" id="edit_lastName" placeholder="Last Name" maxlength="20">
                        </div>
                        <div class="col-6">
                            <label class="form-label required">First Name</label>
                            <input type="text" class="form-control" name="edit_firstName" id="edit_firstName" placeholder="First Name" maxlength="20">
                        </div>
                    </div>
                    <div class="row d-flex align-items-center mt-3">
                        <div class="col-6">
                            <label class="form-label">Middle Name</label>
                            <input type="text" class="form-control" name="edit_middleName" id="edit_middleName" placeholder="Middle Name" maxlength="20">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Suffix</label>
