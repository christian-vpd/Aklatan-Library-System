              ...
              <div class="row flex-column flex-md-row flex-fill align-items-center">
                <div class="col">
                  ...
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown {{ request()->routeIs('librarian.category.*') || request()->routeIs('librarian.manageBooks.*') || request()->routeIs('librarian.bookCopies.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ request()->routeIs('librarian.author.*') ? 'active' : '' }}">
                      <a class="nav-link" href="{{ route('librarian.author.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                    ...
                    <li class="nav-item {{ request()->routeIs('librarian.patron.*') ? 'active' : '' }}">
                      <a class="nav-link" href="{{ route('librarian.patron.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                    ...
                    <li class="nav-item {{ request()->routeIs('librarian.announcement.*') ? 'active' : '' }}">
                      <a class="nav-link" href="{{ route('librarian.announcement.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
