        ...
        <div class="card-body border-bottom py-3">
            <div class="tab-content">
                <div class="tab-pane active show" id="tabs-account" role="tabpanel">
                    ...
                    <form method="POST" action="{{ route('librarian.account_settings.update') }}" id="changePersonalInfoForm" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="personal_user_id" id="personal_user_id" value="{{ $user->id}}">
                        <div class="col-12">
                            <p class="fw-bold">Librarian Code: &nbsp; <span class="fw-normal">{{ $user->librarian->librarian_code}}</span></p>
                        </div>
                        <h2 class="fw-bold text-info">Librarian Name</h2>
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-3 col-sm-6 mb-2"> 
                                ...
                                <select class="form-select" name="suffix"> 
                                    <option value="" @selected(old('suffix', $user->librarian->suffix) == '')>No suffix</option> 
                                    <option value="Jr." @selected(old('suffix', $user->librarian->suffix) == 'Jr.')>Jr.</option> 
                                    <option value="Sr." @selected(old('suffix', $user->librarian->suffix) == 'Sr.')>Sr.</option> 
                                    <option value="I" @selected(old('suffix', $user->librarian->suffix) == 'I')>I</option> 
                                    <option value="II" @selected(old('suffix', $user->librarian->suffix) == 'II')>II</option> 
                                    <option value="III" @selected(old('suffix', $user->librarian->suffix) == 'III')>III</option> 
                                    <option value="IV" @selected(old('suffix', $user->librarian->suffix) == 'IV')>IV</option> 
                                </select> 
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-3 col-sm-6 mb-2">
                                ...
                                <input type="text" name="contactNumber" class="form-control" data-mask="09123456789" data-mask-visible="true" placeholder="09123456789" autocomplete="off" maxlength="11" inputmode="numeric" pattern="[0-9]*" value="{{ $user->librarian->contact_number }}">
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-3 col-sm-6 mb-2">
                                ...
                                <option value="Male" @selected(old('suffix', $user->librarian->gender) == 'Male')>Male</option>
                                <option value="Female" @selected(old('suffix', $user->librarian->gender) == 'Female')>Female</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6 col-sm-6 mb-2">
                ...
                <div class="tab-pane" id="tabs-changes-pass" role="tabpanel">
                    ...
                    <form method="POST" action="{{ route('librarian.account_settings.changePassword') }}" id="changePasswordForm">
                        @csrf
