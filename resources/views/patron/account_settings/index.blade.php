                    ...
                    <form method="POST" action="{{ route('patron.account_settings.update') }}" id="changePersonalInfoForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-3 col-sm-6 mb-2">
                                ...
                                <input type="text" class="form-control no-numbers" name="lastName" placeholder="Last Name" maxlength="20" value="{{ $user->patron->last_name }}">
                            </div>
                            <div class="col-12 col-md-3 col-sm-6 mb-2">
                                <label class="form-label required">First Name</label>
                                <input type="text" class="form-control no-numbers" name="firstName" placeholder="First Name" maxlength="20" value="{{ $user->patron->first_name }}">
                            </div>
                            <div class="col-12 col-md-3 col-sm-6 mb-2">
                                <label class="form-label">Middle Name</label>
                                <input type="text" class="form-control no-numbers" name="middleName" placeholder="Middle Name" maxlength="20" value="{{ $user->patron->middle_name }}">
                            </div>
                            <div class="col-12 col-md-3 col-sm-6 mb-2"> 
